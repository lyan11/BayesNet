...
def rec_multiply_factors(Factors, newFactorScope, newFactor, total=1): 
    ''' NOTE: This algorithm is designed akin to the way the
    recursive_print_values method in the Factor class is designed.
    '''
